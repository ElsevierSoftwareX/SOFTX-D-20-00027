...
void exampleObject() {
    ...
    std::shared_ptr<Object> o1 = std::shared_ptr<Object>(new Object(obj1Id, f1->getID()));
    std::shared_ptr<Object> o2 = std::shared_ptr<Object>(new Object(obj2Id, f2->getID()));
    std::shared_ptr<Object> o3 = std::shared_ptr<Object>(new Object(obj3Id, f2->getID()));
    std::shared_ptr<Object> o4 = std::shared_ptr<Object>(new Object(obj4Id, f3->getID()));
