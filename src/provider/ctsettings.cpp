...
#define setDefault(name, val, changeable, cname, desc) \
    { \
        ...
        CTOption *o = new CTOption(name, changeable, cname, desc); \
        options.push_back(o); \
    }
